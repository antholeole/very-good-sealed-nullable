...
import 'package:verygood/nullable_counter/view/nullable_counter_page.dart';

import '../../helpers/helpers.dart';

class MockCounterCubit extends MockCubit<NullableCounterState>
    implements NullableCounterCubit {}
...
void main() {
  ...
  group('CounterView', () {
    ...
    late NullableCounterCubit counterCubit;
    ...
    testWidgets('renders current count', (tester) async {
      ...
      when(() => counterCubit.state)
          .thenReturn(NullableCounterState.withValue(0));
